...
// windows path
//define('BASH_PATH', 'C:/xampp/htdocs/codeigniter-calendar/');
// Ubuntu path
//define('BASH_PATH', '/var/www/codeigniter-calendar/');
// Mac Path
define('BASH_PATH', '/Applications/XAMPP/htdocs/codeigniter-calendar/');
